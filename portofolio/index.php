        ...
        ?>
            ...
            <nav class="nav-menu">
                <ul>
                    ...
                    <li><a href="#blog"><i class="bx bx-world"></i> <span>Blog</span></a></li>
...
while($data4=mysqli_fetch_array($runquery4)){
    ...
    <section id="blog" class="blog section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Blog</h2>
        <p>menyibukkan diri di berbagai aktivitas</p>
      </div><!-- End Title -->
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item  position-relative">
              ...
              <a href="#" class="stretched-link">
                <h3>Eksplorasi alat IOT</h3>
              </a>
              <p>Anda dapat mengeksplorasi bagaimana IoT dapat diimplementasikan untuk memantau kualitas udara, kualitas air, suhu lingkungan, serta faktor-faktor lingkungan lainnya secara real-time.</p>
            </div>
          </div><!-- End blog Item -->
    </section>
