...
?> 
  ...
  <div class="form-group col-md-12">
    <label for="exampleFormControlTextarea1">Description (opsional)</label>
...
while($data2=mysqli_fetch_array($queryrun2)){
  ...
  <option value="pe" selected>Experience</option>
                    <?php    }
                        ?>
   ...
   <div class="form-group col-md-4">
    <label for="website">Duration or Time Period</label>
    <input type="text" name="year" value="<?=$data2['year']?>" class="form-control" id="website" placeholder="" required>
  </div>
  <div class="form-group col-md-12">
    <label for="exampleFormControlTextarea1">Description (opsional)</label>
